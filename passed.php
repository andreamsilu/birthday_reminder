...
<div class="main">
    <h2 id="list">Passed Birthdays</h2>
     <!-- Search form -->
    ...
    <table class="table">
        ...
        <tbody>
            <?php
            // Include your PHP code here to fetch and display passed birthdays
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $birthdayMonthDay = date("m-d", strtotime($row['birthday']));

                    // Check if the birthday has passed for the current year
                ...
                echo "<tr><td colspan='4'>No passed birthdays found</td></tr>";
            }
